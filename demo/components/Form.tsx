  ...
  return (
    <Form {...form}>
      <form
        ...
        className="mx-auto w-[500px] space-y-8"
      >
        <h2 className="text-center text-4xl font-bold">My Form</h2>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="swifty" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="taylor@swift.com" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
